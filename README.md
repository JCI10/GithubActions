[![Run App]([![Run App <Irwin>, <Jason>](https://github.com/JCI10/GithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/JCI10/GithubActions/actions/workflows/ci.yml)
